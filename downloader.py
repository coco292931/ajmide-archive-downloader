...
DEFAULT_PROGRAM_SCHEDULES = [
    {"name": "the night mix", "code": "459", "slots": [{"days": [1, 2, 3, 4, 5], "start": "00:00", "end": "06:00"}, {"days": [6, 7], "start": "00:00", "end": "08:00"}]},
    ...
    {"name": "Weekend Morning Show", "code": "464", "slots": [{"days": [7], "start": "09:00", "end": "12:00"}]},
    {"name": "Hit FM OST电影原声坊", "code": "465", "slots": [
        {"days": [7], "start": "16:00", "end": "18:00"},
        {"days": [7], "start": "12:00", "end": "14:00"}
    ]},
    {"name": "Lazy Afternoon慵懒下午茶", "code": "466", "slots": [{"days": [1, 2, 3, 4, 5], "start": "13:00", "end": "16:00"}]},
    {"name": "Hit the Road在路上", "code": "467", "slots": [
        {"days": [6], "start": "12:00", "end": "14:00"},
        {"days": [7], "start": "14:00", "end": "16:00"}
    ]},
    {"name": "hitfm live", "code": "468", "slots": [{"days": [6], "start": "15:00", "end": "16:00"}]},
    {"name": "hitfm live+嘻哈公园", "code": "469", "slots": [{"days": [6], "start": "16:00", "end": "18:00"}]},
    ...
    {"name": "hitfm remix", "code": "474", "slots": [{"days": [6], "start": "20:00", "end": "22:00"}]},
    {"name": "Hit FM Dance电音", "code": "475", "slots": [
        {"days": [1, 2, 3, 4, 5, 6, 7], "start": "22:00", "end": "23:59"},
        {"days": [7], "start": "20:00", "end": "23:59"}
    ]},
    ...
    {"name": "CTDM Chart《中国电子音乐巅峰榜》", "code": "32865", "slots": [
        {"days": [6, 7], "start": "20:00", "end": "00:00"}
    ]},
    {"name": "music flow", "code": "32864", "slots": [
        {"days": [1, 2, 3, 4, 5], "start": "00:00", "end": "06:00"},
        {"days": [6, 7], "start": "00:00", "end": "08:00"}
    ]},
